...
const Cards = () => {
  ...
  return (
    <div className="relative flex gap-4 h-[600px] overflow-visible">
      {/* First Card */}
      <div className="w-96 absolute z-30 bg-[rgba(252,252,232,1)] mt-24 pr-6 rounded-2xl shadow-lg transform rotate-[-2deg]">
      ...
      {/* Second Card */}
      <div className="w-96 absolute z-20 bg-[rgba(252,252,232,0.9)] mt-28 ml-8 pr-6 rounded-2xl shadow-lg transform rotate-[-1deg]">
        <div className="opacity-70">
          <div className="flex items-center pt-6 pb-4 px-6">
            <div className="border-[rgba(52,199,89,1)] bg-[rgba(52,199,89,0.2)] border-4 w-5 h-5 rounded-full"></div>
            <h1 className="text-[26px] font-black ml-2">In Progress</h1>
          </div>
          <div>
            <p className="text-[19px] text-start text-gray-800 ml-12 mb-3.5">
      ...
      {/* Third Card */}
      <div className="w-96 absolute z-10 bg-[rgba(252,252,232,0.8)] mt-32 ml-16 pr-6 rounded-2xl shadow-lg">
        <div className="opacity-60">
          <div className="flex items-center pt-6 pb-4 px-6">
            <div className="border-[rgba(0,122,255,1)] bg-[rgba(0,122,255,0.2)] border-4 w-5 h-5 rounded-full"></div>
            <h1 className="text-[26px] font-black ml-2">Up Next</h1>
          </div>
          <div>
            <p className="text-[19px] text-start text-gray-800 ml-12 mb-3.5">
              Review new features
